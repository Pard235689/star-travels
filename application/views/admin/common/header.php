...
<head>
    ...
    <title>STAR TRAVELS Admin Pannel</title>
    ...
    <link href="<?= base_url('assets/admin/assets/libs/bootstrap-datepicker/dist/css/bootstrap-datepicker.min.css'); ?>" rel="stylesheet">
    <!-- Custom CSS -->
            ...
            <nav class="navbar top-navbar navbar-expand-md navbar-dark">
                <div class="navbar-header">
                    ...
                    <div class="navbar-brand">
                        <a href="<?= base_url('AdminHome/index'); ?>" class="logo" style="color:white;">
                            <!-- Logo icon -->
                            <b class="logo-icon">
                                <!--You can put here icon as well // <i class="wi wi-sunset"></i> //-->
                                <!-- Dark Logo icon -->
                                 <span style="color:#faa61a; margin-right:5px;"><i class="fa fa-plane"></i> STAR</span>TRAVELS
                                <!-- Light Logo icon -->
                                <!-- <img src="<?= base_url('assets/images/favicon.png'); ?>" alt="homepage" class="light-logo" /> -->
                            </b>
                            <!--End Logo icon -->
                            <!-- Logo text -->
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle waves-effect waves-dark pro-pic" href="#" data-toggle="dropdown"
                                ...
                                <span class="mr-3 font-normal d-none d-sm-inline-block pro-name"><span>Hello,</span>
                                    Praduman Kushwaha</span>
                                <img src="<?= base_url('assets/images/client-1.jpg'); ?>" alt="user" class="rounded-circle" width="40">
                            </a>
                            <div class="dropdown-menu dropdown-menu-right user-dd animated flipInY">
                                <div class="d-flex no-block align-items-center p-3 bg-light mb-2">
                                    <div class="">
                                        <img src="<?= base_url('assets/images/client-1.jpg'); ?>" alt="user" class="rounded-circle"
                                            width="60">
                                    </div>
                                    <div class="ml-2">
                                        <h4 class="mb-0">Praduman Kushwaha</h4>
                                        <p class="mb-0">pard235689@gmail.com</p>
                                    </div>
                                </div>
