 <!-- ============================================================== -->
            <!-- footer -->
            <!-- ============================================================== -->
            <footer class="footer text-center " style="position:sticky; bottom:0px;right:40vw; ">
                All Rights Reserved by Praduman Kushwaha
            </footer>
            <!-- ============================================================== -->
            <!-- End footer -->
            <!-- ============================================================== -->
    ...
    <script src="<?= base_url('assets/admin/cdn.datatables.net/buttons/1.5.1/js/dataTables.buttons.min.js'); ?>"></script>
    <script src="<?= base_url('assets/admin/cdn.datatables.net/buttons/1.5.1/js/buttons.flash.min.js'); ?>"></script>
    <script src="<?= base_url('assets/admin/cdnjs.cloudflare.com/ajax/libs/jszip/3.1.3/jszip.min.js'); ?>"></script>
    <script src="<?= base_url('assets/admin/cdnjs.cloudflare.com/ajax/libs/pdfmake/0.1.32/pdfmake.min.js'); ?>"></script>
    <script src="<?= base_url('assets/admin/cdnjs.cloudflare.com/ajax/libs/pdfmake/0.1.32/vfs_fonts.js'); ?>"></script>
    <script src="<?= base_url('assets/admin/cdn.datatables.net/buttons/1.5.1/js/buttons.html5.min.js'); ?>"></script>
    <script src="<?= base_url('assets/admin/cdn.datatables.net/buttons/1.5.1/js/buttons.print.min.js'); ?>"></script>
