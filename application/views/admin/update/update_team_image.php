                                ...
                                <div class="d-flex align-items-center">
                                    <nav aria-label="breadcrumb">
                                        <ol class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item">
                                                <a href="<?= base_url('AdminHome/team_master')?>" class="link">Team Master</a>
                                            </li>
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="card">
                                    <div class="card-body">
                                        <h4 class="card-title">Team Image Update Form</h4>
                                        <h5 class="card-subtitle"> Upload all type of images </h5>
                                        <form class="form" method="POST" action="<?= base_url('AdminHome/update_team_image') ?>" enctype="multipart/form-data">
                                            ...
                                            <div class="form-group mt-5 row">
                                                ...
                                                <input class="form-control border-secondary" type="text" name="designation" value="<?= $data->designation; ?>" id="example-text-input" placeholder="Enter Designation">
