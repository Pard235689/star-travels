            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-7 align-self-center">
                        ...
                        <h4 class="page-title">Testimonial Master</h4>
                    </div>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="card">
                            <div class="card-body ">
                                <h4 class="card-title">Testimonial Image Upload Form</h4>
                                <h5 class="card-subtitle"> Upload all type of images </h5>
                                <form class="form" method="POST" action="<?= base_url('AdminHome/add_testimonial_image') ?>" enctype="multipart/form-data">
                                    <div class="form-group mt-5 row">
                                        <label for="example-text-input" class=" col-form-label text-dark">Name :</label><br><br>
                                        <input class="form-control border-secondary" type="text" required name="name" value="" id="example-text-input" placeholder="Enter Member Name">
                                        <br>
                                        ...
                                        <textarea class="form-control border-secondary" rows="3" required name="description" ></textarea>
                                        <br><br>
                                        <label class=" col-form-label text-dark">Upload image file</label>
                                        <input type="file" name="image_path" required class="form-control border-secondary"><br><br><br>
                                    ...
                                    <table class="table" >
                                        ...
                                        <?php $i=1; foreach($data as $value): ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <form method="POST" action="<?= base_url('AdminHome/edit_testimonial_image')?>">
                                                ...
                                                <td>
                                                    <form method="POST" action="<?= base_url('AdminHome/delete_testimonial_image')?>">
                                                    <input type="hidden" name="id" value="<?= $value->image_id ;?>">
                                                    <input type="hidden" name="old_image" value="<?= $value->image_path ;?>">
